      ...
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">新規登録</h1>
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-3">
                    <label for="remember-me" class="text-sm dark:text-white">ログイン情報を保存する</label>
                  </div>
                </div>
                <!-- End Checkbox -->

                <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">新規登録</button>
              </div>
            </form>
            <!-- End Form -->
          </div>
